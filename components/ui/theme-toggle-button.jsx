...
export default function ThemeToggleButton({
  ...
  return (
    <Button
      ...
      <MoonIcon
        className="text-black absolute size-[1.2rem] rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100" />
      <span className="sr-only">Theme Toggle </span>
      {showLabel && (
        <>
          <span
            className="hidden group-hover:block border border-rounded-full px-2 absolute -top-10">
            {" "}
            variant = {variant}
          </span>
          <span
